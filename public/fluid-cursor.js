 ...
 * Self-initializing IIFE — no import needed.
 * Drop in via <script src="/fluid-cursor.js"></script>
 */
(function () {
    const config = {
        SIM_RESOLUTION: 128,
    ...
    window.addEventListener('touchstart', (e) => {
        ...
        let pointer = pointers[0];
        updatePointerDownData(pointer, touches[0].identifier,
            scaleByPixelRatio(touches[0].clientX), scaleByPixelRatio(touches[0].clientY));
    });
